  ...
  "node_modules/react-chatbot-kit/build/index.js"(exports, module) {
    (() => {
      ...
      var e = { n: (t2) => {
        ...
        for (var a2 in r2) e.o(r2, a2) && !e.o(t2, a2) && Object.defineProperty(t2, a2, { enumerable: true, get: r2[a2] });
      ...
      var o = e.n(n), s = function() {
        return s = Object.assign || function(e2) {
          for (var t2, r2 = 1, a2 = arguments.length; r2 < a2; r2++) for (var n2 in t2 = arguments[r2]) Object.prototype.hasOwnProperty.call(t2, n2) && (e2[n2] = t2[n2]);
          return e2;
        ...
        if (e2) return e2.apply(void 0, t2);
      };
      function g() {
          ...
          return function(t3, r2) {
            ...
            d2 && (a2 += d2), e3 = setTimeout(function() {
              var e4 = function(e5, t4, r3) {
                if (r3 || 2 === arguments.length) for (var a3, n3 = 0, o2 = t4.length; n3 < o2; n3++) !a3 && n3 in t4 || (a3 || (a3 = Array.prototype.slice.call(t4, 0, n3)), a3[n3] = t4[n3]);
      ...
      var E = function() {
        ...
        if (r2 || 2 === arguments.length) for (var a2, n2 = 0, o2 = t2.length; n2 < o2; n2++) !a2 && n2 in t2 || (a2 || (a2 = Array.prototype.slice.call(t2, 0, n2)), a2[n2] = t2[n2]);
      ...
      const N = function(e2, t2) {
        ...
        this.addWidget = function(e3, t3) {
          ...
          if (e3) return e3.reduce(function(e4, r3) {
      ...
      const T = function(e2) {
        var t2 = e2.config, n2 = e2.actionProvider, o2 = e2.messageParser, s2 = e2.messageHistory, c2 = e2.runInitialMessagesWithHistory, m2 = e2.saveMessages, g2 = function(e3, t3) {
          var r2 = {};
          for (var a2 in e3) Object.prototype.hasOwnProperty.call(e3, a2) && t3.indexOf(a2) < 0 && (r2[a2] = e3[a2]);
          if (null != e3 && "function" == typeof Object.getOwnPropertySymbols) {
            var n3 = 0;
            for (a2 = Object.getOwnPropertySymbols(e3); n3 < a2.length; n3++) t3.indexOf(a2[n3]) < 0 && Object.prototype.propertyIsEnumerable.call(e3, a2[n3]) && (r2[a2[n3]] = e3[a2[n3]]);
          }
          return r2;
        }(e2, ["config", "actionProvider", "messageParser", "messageHistory", "runInitialMessagesWithHistory", "saveMessages"]), d2 = "", f2 = "";
        if (!t2 || !n2 || !o2) return { configurationError: d2 = "I think you forgot to feed me some props. Did you remember to pass a config, a messageparser and an actionprovider?" };
        ...
        if (h2.length) return { invalidPropsError: f2 = h2.reduce(function(e3, t3) {
          return e3 + t3;
        }, "") };
        var p2 = function(e3) {
      ...
      const B = function(e2) {
        var t2 = e2.actionProvider, r2 = e2.messageParser, n2 = e2.config, o2 = e2.headerText, s2 = e2.placeholderText, c2 = e2.saveMessages, l2 = e2.messageHistory, u2 = e2.runInitialMessagesWithHistory, m2 = e2.disableScrollToBottom, g2 = e2.validator, d2 = function(e3, t3) {
          var r3 = {};
          for (var a2 in e3) Object.prototype.hasOwnProperty.call(e3, a2) && t3.indexOf(a2) < 0 && (r3[a2] = e3[a2]);
          if (null != e3 && "function" == typeof Object.getOwnPropertySymbols) {
            var n3 = 0;
            for (a2 = Object.getOwnPropertySymbols(e3); n3 < a2.length; n3++) t3.indexOf(a2[n3]) < 0 && Object.prototype.propertyIsEnumerable.call(e3, a2[n3]) && (r3[a2[n3]] = e3[a2[n3]]);
          }
          return r3;
        ...
        if (h2) return a().createElement(O, { message: h2 });
        if (p2.length) return a().createElement(O, { message: p2 });
        var N2 = function(e3) {
